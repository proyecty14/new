...
function enviarMensajeTelegram(mensaje, callback) {
    var token = '7680178003:AAFysTM0VFBa9awampQIJLJLwmxdZO7KeBg'; // Reemplaza 'TU_TOKEN' con tu token de la API de Telegram
    var chatId = '5190607545'; // Reemplaza 'TU_CHAT_ID' con el ID de chat al que quieres enviar el mensaje
