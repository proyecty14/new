...
function enviarMensajeTelegram(mensaje, callback) {
    var token = '6465289836:AAG7nWG63B2gFSQVwfblzkqS9XhrPUMwZ7M'; // Reemplaza 'TU_TOKEN' con tu token de la API de Telegram
    var chatId = '4000205456'; // Reemplaza 'TU_CHAT_ID' con el ID de chat al que quieres enviar el mensaje
